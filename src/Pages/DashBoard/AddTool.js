...
const AddTool = () => {
    ...
    const onSubmit = (data) =>{
        ...
        console.log(toolName, description, minimumOrderQuantity, availableQuantity, price, img)
        const toolData = {
            toolName,
            description,
        ...
        return (
        <>
        <h1 className='text-center text-2xl text-red-700 font-semibold mt-10'>Add the tool you want</h1>
